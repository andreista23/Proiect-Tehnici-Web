...
client.query("SELECT * FROM biciclete", function(err,rez){
    console.log(rez);});
obGlobal = {
    obErori:null,
    obImagini:null,
...
client.query("select * from unnest(enum_range(null::dimensiuni_roata))", function(err, rezCategorie){
    if (err){
        console.log(err);
    }
    else{
...
app.get("/produse", function(req, res){
    ...
    client.query("select * from unnest(enum_range(null::categ_bicicleta))", function(err, rezOptiuni){
        client.query(`select * from biciclete ${conditieQuery}`, function(err, rez){
            if (err){
                console.log(err);
                afisareEroare(res, 2);
            }
...
app.get("/produs/:id", function(req, res){
    client.query(`select * from biciclete where id=${req.params.id}`, function(err, rez){
        if (err){
            console.log(err);
            afisareEroare(res, 2);
        }
...
app.post("/login",function(req, res){
    ...
    */
    ...
    formular.parse(req, function(err, campuriText, campuriFisier ){
        ...
        Utilizator.getUtilizDupaUsername (campuriText.username[0],parametriCallback, function(u, obparam, eroare ){//proceseazaUtiliz
